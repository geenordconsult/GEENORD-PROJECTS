...
INPUT_RANGES = {
    'N': {'min': 0.0, 'max': 150.0, 'default': 90.0, 'help': 'Available Nitrogen in soil (e.g., mg/kg or ppm).'},
    'P': {'min': 5.0, 'max': 215.0, 'default': 42.0, 'help': 'Available Phosphorus in soil (e.g., mg/kg or ppm).'},
    'K': {'min': 5.0, 'max': 155.0, 'default': 43.0, 'help': 'Available Potassium in soil (e.g., mg/kg or ppm).'},
    'ph': {'min': 3.5, 'max': 11.0, 'default': 5.5, 'help': 'Soil acidity/alkalinity level (3.5 = highly acidic, 9.5 = highly alkaline).'}
}
